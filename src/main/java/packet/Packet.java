...
public class Packet {
    ...
    public static Packet decodePackage(byte[] bytes) {
        ...
        if (buffer.get() != MAGIC_BYTE) {
            throw new IllegalArgumentException("magic byte check failed!");
        }
        ...
        System.out.println("Lab1.Packet.CRC16 (head):  " + crcHead);
        ...
        if (CRC16.crc16(head) != crcHead) {
            throw new IllegalArgumentException("Lab1.Packet.CRC16 head validation failed!");
        }
        ...
        if (CRC16.crc16(msgEnc) != crc16msg) {
            throw new IllegalArgumentException("Lab1.Packet.CRC16 message validation failed!");
        }
